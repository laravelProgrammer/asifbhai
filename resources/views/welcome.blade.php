                            ...
                            <div class="row">
                                <div class="col text-center">
                                    ...
                                    <div class="home_slider_form_container">
                                        <form action="{{route('search-result')}}" id="home_search_form_1" class="home_search_form d-flex flex-lg-row flex-column align-items-center justify-content-between" method="post">
                                            @csrf
