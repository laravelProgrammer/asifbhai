   <?php $__env->startSection('main-content'); ?>
    ...
    <div class="home">
        <div class="home_slider_container">
            ...
            <div class="owl-carousel owl-theme home_slider">
                ...
                <!-- Home Slider Item -->
                <div class="owl-item">
                    <div class="home_slider_background" style="background-image:url(website-assets/images/home_slider_1.jpg)"></div>
                            ...
                            <div class="row">
                                <div class="col text-center">
                                    ...
                                    <div class="home_slider_form_container">
                                        <form action="<?php echo e(route('search-result')); ?>" id="home_search_form_1" class="home_search_form d-flex flex-lg-row flex-column align-items-center justify-content-between" method="post">
                                            <?php echo csrf_field(); ?>
                                            <div class="d-flex flex-row align-items-center justify-content-start">
                                                <input type="search" class="home_search_input" placeholder="Keyword Search" >
                                                <select class="dropdown_item_select home_search_input" name="search_subject">
                                                ...
                                                <select class="dropdown_item_select home_search_input" name="search_class">
            ...
            <div class="row features_row">
                ...
                <div class="col-lg-3 feature_col">
                    <div class="feature text-center trans_400">
                        <div class="feature_icon"><img src="website-assets/images/icon_1.png" alt=""></div>
                ...
                <div class="col-lg-3 feature_col">
                    <div class="feature text-center trans_400">
                        <div class="feature_icon"><img src="website-assets/images/icon_2.png" alt=""></div>
                ...
                <div class="col-lg-3 feature_col">
                    <div class="feature text-center trans_400">
                        <div class="feature_icon"><img src="website-assets/images/icon_3.png" alt=""></div>
                ...
                <div class="col-lg-3 feature_col">
                    <div class="feature text-center trans_400">
                        <div class="feature_icon"><img src="website-assets/images/icon_4.png" alt=""></div>
    ...
    <div class="courses">
        <div class="section_background parallax-window" data-parallax="scroll" data-image-src="website-assets/images/courses_background.jpg" data-speed="0.8"></div>
        <div class="container">
            <div class="row">
                <div class="col">
                    <div class="section_title_container text-center">
            ...
            <div class="row courses_row">
                ...
                <div class="col-lg-4 course_col">
                    <div class="course">
                        <div class="course_image"><img src="website-assets/images/course_1.jpg" alt=""></div>
                ...
                <div class="col-lg-4 course_col">
                    <div class="course">
                        <div class="course_image"><img src="website-assets/images/course_2.jpg" alt=""></div>
                        <div class="course_body">
                ...
                <div class="col-lg-4 course_col">
                    <div class="course">
                        <div class="course_image"><img src="website-assets/images/course_3.jpg" alt=""></div>
                        <div class="course_body">
            ...
            <div class="row events_row">
                ...
                <div class="col-lg-4 event_col">
                    <div class="event event_left">
                        <div class="event_image"><img src="website-assets/images/event_1.jpg" alt=""></div>
                ...
                <div class="col-lg-4 event_col">
                    <div class="event event_mid">
                        <div class="event_image"><img src="website-assets/images/event_2.jpg" alt=""></div>
                        <div class="event_body d-flex flex-row align-items-start justify-content-start">
                            <div class="event_date">
                                <div class="d-flex flex-column align-items-center justify-content-center trans_200">
                ...
                <div class="col-lg-4 event_col">
                    <div class="event event_right">
                        <div class="event_image"><img src="website-assets/images/event_3.jpg" alt=""></div>
                        <div class="event_body d-flex flex-row align-items-start justify-content-start">
                            <div class="event_date">
                                <div class="d-flex flex-column align-items-center justify-content-center trans_200">
    ...
    <div class="team">
        <div class="team_background parallax-window" data-parallax="scroll" data-image-src="website-assets/images/team_background.jpg" data-speed="0.8"></div>
        <div class="container">
            <div class="row">
                <div class="col">
                    <div class="section_title_container text-center">
            ...
            <div class="row team_row">
                ...
                <div class="col-lg-3 col-md-6 team_col">
                    <div class="team_item">
                        <div class="team_image"><img src="website-assets/images/team_1.jpg" alt=""></div>
                        <div class="team_body">
                ...
                <div class="col-lg-3 col-md-6 team_col">
                    <div class="team_item">
                        <div class="team_image"><img src="website-assets/images/team_2.jpg" alt=""></div>
                        <div class="team_body">
                ...
                <div class="col-lg-3 col-md-6 team_col">
                    <div class="team_item">
                        <div class="team_image"><img src="website-assets/images/team_3.jpg" alt=""></div>
                        <div class="team_body">
                ...
                <div class="col-lg-3 col-md-6 team_col">
                    <div class="team_item">
                        <div class="team_image"><img src="website-assets/images/team_4.jpg" alt=""></div>
                        <div class="team_body">
                ...
                <div class="col-lg-7 news_col">
                    ...
                    <div class="news_post_large_container">
                        <div class="news_post_large">
                            <div class="news_post_image"><img src="website-assets/images/news_1.jpg" alt=""></div>
...
<?php echo $__env->make('web-site.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\asifbhai\LesCours-master\resources\views/welcome.blade.php ENDPATH**/ ?>