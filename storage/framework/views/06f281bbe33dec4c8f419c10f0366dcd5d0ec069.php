<div class="side-menu sidebar-inverse">
    <nav class="navbar navbar-default" role="navigation">
        ...
        <div id="adminmenu">
            ...
            <?php else: ?>
                <?php echo $__env->make('voyager::menu.default', ['items' => menu($role, '_json')], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            <?php endif; ?>
        </div>
    </nav>
</div>
<?php /**PATH E:\xampp\htdocs\asifbhai\LesCours-master\resources\views/vendor/voyager/dashboard/sidebar.blade.php ENDPATH**/ ?>