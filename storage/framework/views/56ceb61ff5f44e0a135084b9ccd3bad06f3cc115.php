	                            		...
	                            		<a href="<?php echo e(route('voyager.availabilities.show', $availability->id)); ?>">
		                            		<div class="panel profile-card">
		                            			<div class="panel-header">
		                            				<img src="<?php echo e(asset('storage/'.$availability->teacher->avatar)); ?>" width="100%" height="250px">
		                            			</div>
...
<?php echo $__env->make('voyager::master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\asifbhai\LesCours-master\resources\views/tutor/list.blade.php ENDPATH**/ ?>